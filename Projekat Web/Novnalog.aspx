<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Novnalog.aspx.cs" Inherits="Projekat_Web.Novnalog" %>
...
<body>
    <form id="form1" runat="server">
        <div class="main">
            ...
            <p>
                Ili 
                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click"> Vec imas nalog? </asp:LinkButton>
            </p>
